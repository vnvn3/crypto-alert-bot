### **📌 برنامه اول: کد بهینه‌سازی‌شده برای اسپایک (با لیست ارزهای کامل‌تر و بهینه برای GitHub Actions)**
*(این کد نسخه اصلاح‌شده کد قبلی است با لیست ارزهای بیشتر و بهینه‌سازی برای اجرا در GitHub Actions)*

---

---

### **🔥 کد اول: `spike_detector.py` (اسپایک در 15 دقیقه)**
```python
import requests
import os
import html
